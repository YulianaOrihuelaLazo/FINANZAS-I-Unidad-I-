...
Original file is located at
    https://colab.research.google.com/drive/134GnHn0eZC5uw2srts9tq8I_-23XFZtx
"""
...
# Fecha de extracción: 26/09/2026
"""
04_analisis.py
...
def main():
    ...
    #           Se separa en 2 paneles por escala de cotizacion (USD vs.
    #           PEN): mezclar a SCCO/BAP (decenas-cientos de USD) con los
    #           8 emisores en soles (unidades-decenas) hacia ilegible el
    #           grafico de un solo panel; con escalas propias cada punto
    #           se distingue con claridad. ----
    TICKERS_USD = {"SCCO", "BAP"}

    fig, (ax1, ax2) = plt.subplots(1, 2, figsize=(14, 7))
    paneles = [
        (ax1, base_valida[base_valida["Ticker"].isin(TICKERS_USD)],
         "Emisores en USD (SCCO, BAP)"),
        (ax2, base_valida[~base_valida["Ticker"].isin(TICKERS_USD)],
         "Emisores en PEN (los otros 8)"),
    ]

    for ax, datos_panel, titulo in paneles:
        normales = datos_panel[~datos_panel["Evento_dividendo_atipico"]]
        atipicos = datos_panel[datos_panel["Evento_dividendo_atipico"]]
        ...
        lim_max = max(datos_panel["Valor_teorico"].max(),
                      datos_panel["Precio_cierre_fin_anio"].max()) * 1.08
    ...
    fig.suptitle("Precio de mercado vs. Valor teorico, por emisor-año\n"
